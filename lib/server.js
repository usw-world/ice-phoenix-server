...
app.post('/get-data', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return GetData(req.body.userKey);
          case 2:
            gameData = _context2.sent;
            if (!gameData) {
              res.statusCode = 500;
              res.json({
                result: 500,
...
app.post('/sync-data', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            gameData = _objectSpread({}, JSON.parse(req.body.dataJson));
            _context3.next = 3;
            return UpdateData(gameData);
          case 3:
            if (!_context3.sent) {
              _context3.next = 7;
              break;
...
function _CreateUser() {
  _CreateUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(res) {
    var userKey, tryCount;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 1:
            tryCount++;
            userKey = _crypto["default"].randomBytes(64).toString('base64');
          case 3:
            _context4.next = 5;
